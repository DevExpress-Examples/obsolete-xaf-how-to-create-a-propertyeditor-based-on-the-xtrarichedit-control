<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/128588745/11.1.7%2B)
...
<p>1. RichEditPropertyEditor is now associated with properties via the EditorAlias attribute.</p><p>2. The IInplaceEditSupport interface has been implemented, and RichEditPropertyEditor now can be used to show RTF text in list views.</p>
